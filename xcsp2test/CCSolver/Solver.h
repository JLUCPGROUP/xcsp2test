...
enum ACAlgorithm {
	CA_AC1, CA_AC2, AC_3, AC_4, AC_6, AC_7, AC_2001, AC_3bit, AC_3rm, STR_1, STR_2, STR_3, A_FC, A_FC_bit, A_NSAC, CA_LMRPC_BIT, CA_RPC3
};
enum Consistency {
...
public:
	...
	bool have_pc_wit(IntVar& i, const int a, const IntVar& j, int b, IntVar& k, const int p);
	int next_support_bit(IntVar& i, const int a, IntVar& j, const int v, const int p);
